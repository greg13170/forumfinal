<center>
    <a href="?page=mp">Retour aux messages reçus</a> | <a href="?page=mp&mp=envoyer">Envoyer un message</a><br><br>
<?php
...
if(isset($_SESSION['login'])) {
    ...
    $req = $bdd->query("SELECT * FROM mp WHERE id_envoyeur = '".$_SESSION['id_user']."'"); //Nous récupérons le contenu de la requête dans $retour_total
    ...
    if($donnees_total > 0)  {
        ...
        echo "Vous avez envoyé ".$donnees_total." messages<br><br><br>";
        ...
        $retour_messages = $bdd->query("SELECT * FROM mp WHERE id_envoyeur = ".$_SESSION['id_user']." ORDER BY id DESC LIMIT ".$premiereEntree.", ".$nombreMessages);
        while($donnees_messages = $retour_messages->fetch(PDO::FETCH_ASSOC)) // On lit les entrées une à une grâce à une boucle
        {
             ...
             //De plus j'ajoute aussi un nl2br pour prendre en compte les sauts à la ligne dans le message.
                ...
                . "<a href='?page=mp&mp=lecture&id=".$donnees_messages['id']."&etat=envoyeur'>Titre : ".$donnees_messages['titre']."</a><p><br>";
        ...
        echo "Vous n'avez pas envoyé de messages privés";
    }
}   else    {
